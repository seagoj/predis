 ...
 * @method keys($pattern)
 * @method move($key, $db)
 * @method object($subcommand, $key)
 * @method persist($key)
 * @method pexpire($key, $milliseconds)
 * @method pexpireat($key, $timestamp)
 * @method pttl($key)
 * @method randomkey()
 * @method rename($key, $target)
 * @method renamenx($key, $target)
 * @method scan($cursor, array $options = null)
 * @method sort($key, array $options = null)
 * @method ttl($key)
 * @method type($key)
 * @method append($key, $value)
 * @method bitcount($key, $start = null, $end = null)
 * @method bitop($operation, $destkey, $key)
 * @method decr($key)
 * @method decrby($key, $decrement)
 * @method get($key)
 * @method getbit($key, $offset)
 * @method getrange($key, $start, $end)
 * @method getset($key, $value)
 * @method incr($key)
 * @method incrby($key, $increment)
 * @method incrbyfloat($key, $increment)
 * @method mget(array $keys)
 * @method mset(array $dictionary)
 * @method msetnx(array $dictionary)
 * @method psetex($key, $milliseconds, $value)
 * @method set($key, $value, $expireResolution = null, $expireTTL = null, $flag = null)
 * @method setbit($key, $offset, $value)
 * @method setex($key, $seconds, $value)
 * @method setnx($key, $value)
 * @method setrange($key, $offset, $value)
 * @method strlen($key)
 * @method hdel($key, array $fields)
 ...
 * @method hkeys($key)
 * @method hlen($key)
 * @method hmget($key, array $fields)
 * @method hmset($key, array $dictionary)
 * @method hscan($key, $cursor, array $options = null)
 * @method hset($key, $field, $value)
 * @method hsetnx($key, $field, $value)
 * @method hvals($key)
 * @method blpop(array $keys, $timeout)
 * @method brpop(array $keys, $timeout)
 * @method brpoplpush($source, $destination, $timeout)
 * @method lindex($key, $index)
 * @method linsert($key, $whence, $pivot, $value)
 * @method llen($key)
 * @method lpop($key)
 * @method lpush($key, array $values)
 ...
 * @method rpop($key)
 * @method rpoplpush($source, $destination)
 * @method rpush($key, array $values)
 * @method rpushx($key, $value)
 * @method sadd($key, array $members)
 * @method scard($key)
 * @method sdiff(array $keys)
 * @method sdiffstore($destination, array $keys)
 * @method sinter(array $keys)
 * @method sinterstore($destination, array $keys)
 * @method sismember($key, $member)
 * @method smembers($key)
 * @method smove($source, $destination, $member)
 * @method spop($key)
 * @method srandmember($key, $count = null)
 * @method srem($key, $member)
 * @method sscan($key, $cursor, array $options = null)
 * @method sunion(array $keys)
 * @method sunionstore($destination, array $keys)
 * @method zadd($key, array $membersAndScoresDictionary)
 * @method zcard($key)
 * @method zcount($key, $min, $max)
 * @method zinterstore($destination, array $keys, array $options = null)
 * @method zrange($key, $start, $stop, array $options = null)
 * @method zrangebyscore($key, $min, $max, array $options = null)
 * @method zrank($key, $member)
 * @method zrem($key, $member)
 * @method zremrangebyrank($key, $start, $stop)
 * @method zremrangebyscore($key, $min, $max)
 * @method zrevrange($key, $start, $stop, array $options = null)
 * @method zrevrangebyscore($key, $min, $max, array $options = null)
 * @method zrevrank($key, $member)
 * @method zunionstore($destination, array $keys, array $options = null)
 * @method zscore($key, $member)
 * @method zscan($key, $cursor, array $options = null)
 * @method zrangebylex($key, $start, $stop, array $options = null)
 * @method zremrangebylex($key, $min, $max)
 * @method zlexcount($key, $min, $max)
 * @method pfadd($key, array $elements)
 * @method pfmerge($destinationKey, array $sourceKeys)
 * @method pfcount(array $keys)
 * @method pubsub($subcommand, $argument)
 ...
 * @method unwatch()
 * @method watch($key)
 * @method eval($script, $numkeys, $keyOrArg1 = null, $keyOrArgN = null)
 * @method evalsha($script, $numkeys, $keyOrArg1 = null, $keyOrArgN = null)
 * @method script($subcommand, $argument = null)
 ...
 * @method bgrewriteaof()
 * @method bgsave()
 * @method client($subcommand, $argument = null)
 * @method config($subcommand, $argument = null)
 * @method dbsize()
 * @method flushall()
 * @method flushdb()
 * @method info($section = null)
 * @method lastsave()
 * @method save()
 * @method slaveof($host, $port)
 * @method slowlog($subcommand, $argument = null)
 * @method time()
 * @method command()
 *
